# PGHD OxygenSaturation Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD OxygenSaturation Profile 
...
* Examples for this Profile: [Observation/pghd-oxygenSaturation](Observation-pghd-oxygenSaturation.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-oxygenSaturation)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-oxygenSaturation.csv), [Excel](../StructureDefinition-pghd-oxygenSaturation.xlsx), [Schematron](../StructureDefinition-pghd-oxygenSaturation.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-oxygenSaturation",
  "version" : "1.0.0-ballot2",
  "name" : "PGHDOxygenSaturation",
