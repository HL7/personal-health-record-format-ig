# PGHD Workout Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD Workout Profile 
...
* Examples for this Profile: [Observation/pghd-workout-underwater-diving](Observation-pghd-workout-underwater-diving.md) and [Observation/pghd-workout-walking](Observation-pghd-workout-walking.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-workout)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-workout.csv), [Excel](../StructureDefinition-pghd-workout.xlsx), [Schematron](../StructureDefinition-pghd-workout.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-workout",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/phr/ValueSet/observation-workout-codes"
        }
      },
      {
        ...
        "type" : [
          {
            ...
            "targetProfile" : [
              ...
              "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-nutrition",
              "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-reproductive-health",
              "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-selfcare",
              "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-sleep",
              "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-symptom",
              "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-uvexposure",
