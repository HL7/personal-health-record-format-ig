# pghd-hearingSensitivity-2 - Personal Health Records v1.0.0-ballot2

## Example Observation: pghd-hearingSensitivity-2

Language: en

Profile: [PGHD HearingSensitivity Profile](StructureDefinition-pghd-hearing-sensitivity.md)

**identifier**: `urn:uuid:2a0d59fe-e99f-d216-5865-670442becaa3`/DE430E9B-03F4-4310-ACA1-508787B240CD_2
...
> **component****code**:Frequency**value**: 1000 Hz(Details: UCUM codeHz = 'Hz')

> **component****code**:Left ear sensitivity**value**: 50 dB(Details: UCUM codedB = 'dB')

> **component****code**:Right ear sensitivity**value**: 55 dB(Details: UCUM codedB = 'dB')
