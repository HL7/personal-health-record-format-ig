# pghd-sleep-asleepCore - Personal Health Records v1.0.0-ballot2

## Example Observation: pghd-sleep-asleepCore
...
```json
{
  ...
  "meta" : {
    "profile" : ["http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-sleep"]
  },
  "language" : "en",
  "contained" : [
    {
