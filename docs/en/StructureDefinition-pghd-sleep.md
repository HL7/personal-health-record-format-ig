# PGHD Sleep Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD Sleep Profile 
...
* Examples for this Profile: [Observation/pghd-sleep-asleep-core](Observation-pghd-sleep-asleep-core.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-sleep)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-sleep.csv), [Excel](../StructureDefinition-pghd-sleep.xlsx), [Schematron](../StructureDefinition-pghd-sleep.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-sleep",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/phr/ValueSet/observation-sleep-codes"
        }
      },
      {
      ...
      {
        "id" : "Observation.value[x].coding:sleepAnalysis",
        "path" : "Observation.value[x].coding",
        "sliceName" : "sleepAnalysis",
        "min" : 0,
        "max" : "1",
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/phr/ValueSet/sleep-analysis"
        }
      },
      {
        "id" : "Observation.value[x].coding:sleepAnalysis.system",
        "path" : "Observation.value[x].coding.system",
        "min" : 1,
        "patternUri" : "http://hl7.org/fhir/uv/phr/CodeSystem/sleep-analysis-codes"
      },
      {
