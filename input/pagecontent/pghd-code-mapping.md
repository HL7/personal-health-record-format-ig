## Description
This table provides a comprehensive mapping of Personal Health Record (PHR) data items across multiple coding systems and platforms.
It includes mappings between HealthKit (iOS), Health Connect (Android), LOINC codes, and SNOMED CT codes for items included in the International Patient Summary (IPS).
This facilitates interoperability and data integration across different health data ecosystems.

---

## PHR Code Mapping Table

|Code system|Code value|HealthKit (iOS26)|Health Connect (Android16)|LOINC|SNOMED CT|
|---|---|---|---|---|---|
|Observation PGHD Codes|activeEnergyBurned|activeEnergyBurned|ActiveCaloriesBurnedRecord|||
|Observation PGHD Codes|basalEnergyBurned|basalEnergyBurned|BasalMetabolicRateRecord|||
|Observation PGHD Codes|cyclingPedalingCadence||CyclingPedalingCadenceRecord|||
|Observation PGHD Codes|distance||DistanceRecord|||
|Observation PGHD Codes|elevationGained||ElevationGainedRecord|||
|Observation PGHD Codes|flightsClimbed|flightsClimbed|FloorsClimbedRecord|||
|Observation PGHD Codes|totalEnergyBurned||TotalCaloriesBurnedRecord|41981-2||
|Observation PGHD Codes|appleExerciseTime|appleExerciseTime||-|-|
|Observation PGHD Codes|appleMoveTime|appleMoveTime||-|-|
|Observation PGHD Codes|appleStandHour|appleStandHour||-|-|
|Observation PGHD Codes|appleStandTime|appleStandTime||-|-|
|Observation PGHD Codes|distanceCycling|distanceCycling||93818-3||
|Observation PGHD Codes|distanceDownhillSnowSports|distanceDownhillSnowSports||||
|Observation PGHD Codes|distanceSwimming|distanceSwimming||93816-7||
|Observation PGHD Codes|distanceWalkingRunning|distanceWalkingRunning||||
|Observation PGHD Codes|distanceWheelchair|distanceWheelchair||||
|Observation PGHD Codes|lowCardioFitnessEvent|lowCardioFitnessEvent||||
|Observation PGHD Codes|nikeFuel|nikeFuel||-|-|
|Observation PGHD Codes|physicalEffort|||||
|Observation PGHD Codes|power||PowerRecord|||
|Observation PGHD Codes|pushCount|pushCount|WheelchairPushesRecord|||
|Observation PGHD Codes|runningGroundContactTime|runningGroundContactTime||||
|Observation PGHD Codes|runningPower|runningPower||||
|Observation PGHD Codes|runningSpeed|runningSpeed||||
|Observation PGHD Codes|runningStrideLength|runningStrideLength||||
|Observation PGHD Codes|runningVerticalOscillation|runningVerticalOscillation||||
|Observation PGHD Codes|stepsCadence||StepsCadenceRecord|||
|Observation PGHD Codes|stepCount|stepCount|StepsRecord|55423-8||
|Observation PGHD Codes|speed||SpeedRecord|||
|Observation PGHD Codes|swimmingStrokeCount|swimmingStrokeCount|SwimmingStrokesRecord|||
...
|Observation PGHD Codes|electrodermalActivity|electrodermalActivity||||
...
|Observation PGHD Codes|dietaryChromium|dietaryChromium||||
...
|Observation PGHD Codes|dietaryZinc|dietaryZinc||||
...
|Observation PGHD Codes|abdominalCramps|abdominalCramps||-|51197009(*)|
|Observation PGHD Codes|acne|acne||-|403364000(*)|
|Observation PGHD Codes|appetiteChanges|appetiteChanges||-|249473004(*)|
...
|Observation PGHD Codes|generalizedBodyAche|generalizedBodyAche||-|22253000|
|Observation PGHD Codes|hairLoss|hairLoss||-|278040002(*)|
|Observation PGHD Codes|headache|headache||-|25064002|
|Observation PGHD Codes|heartburn|heartburn||-|16331000|
|Observation PGHD Codes|hotFlashes|hotFlashes||-|198436008|
|Observation PGHD Codes|lossOfSmell|lossOfSmell||-|44169009|
|Observation PGHD Codes|lossOfTaste|lossOfTaste||-|36955009(*)|
|Observation PGHD Codes|lowerBackPain|lowerBackPain||-|279039007|
|Observation PGHD Codes|memoryLapse|memoryLapse||-|225038006(*)|
|Observation PGHD Codes|moodChanges|moodChanges||-|106131003|
|Observation PGHD Codes|nausea|nausea||-|422587007|
|Observation PGHD Codes|nightSweats|nightSweats||-|42984000|
...
|Observation PGHD Codes|sinusCongestion|sinusCongestion||-|68235000|
|Observation PGHD Codes|skippedHeartbeat|skippedHeartbeat||-|80313002|
|Observation PGHD Codes|sleepChanges|sleepChanges||-|247950007(*)|
...
|Observation PGHD Codes|irregularHeartRhythmEvent|irregularHeartRhythmEvent||||
...
|Observation PGHD Codes|gymnastics|gymnastics|GYMNASTICS|||
...
|Observation PGHD Codes|swimming|swimming||||
...
|Observation PGHD Codes|dumbbellTricepsExtensionRightArm||DUMBBELL_TRICEPS_EXTENSION_RIGHT_ARM|||
...
|Observation PGHD Codes|skiing||SKIING|||
...
|Body Temperature Measurement Location Codes|body|body||||
...
|GAD-7 Assesment Risk Codes |mild|mild||||
...
|State of Mind Label Codes|annoyed|annoyed||||
...
|State of Mind Valence Codes|slightlyUnpleasant|slightlyUnpleasant||||
...
Codes marked with "(*)" are not currently officially recognized as part of the International Patient Summary (IPS). Please use these codes with caution. We are in the process of applying for their inclusion in the IPS.