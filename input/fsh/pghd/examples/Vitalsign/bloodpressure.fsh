...
* code
  ...
  * coding[PGHDCode] = $CodeSystemObservationPGHDCodes#bloodPressure "Blood pressure"
  * text = "Blood pressure"
...
* component[SystolicBP]
  ...
  * code
    ...
    * coding[PGHDCode] = $CodeSystemObservationPGHDCodes#bloodPressureSystolic "Blood pressure systolic"
...
* component[DiastolicBP]
  * code
    ...
    * coding[PGHDCode] = $CodeSystemObservationPGHDCodes#bloodPressureDiastolic "Blood pressure diastolic"
