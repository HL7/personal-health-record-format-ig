Instance: pghd-sleep-episode-core-sleep-1
InstanceOf: PGHDSleepEpisode
Description: "SleepEpisode Example"
Usage: #example
// https://opensource.ieee.org/omh/1752/-/blob/main/sample_data/sleep/light-sleep-sample-data.json
* id = "pghd-sleep-episode-core-sleep-1"
* status = #final
