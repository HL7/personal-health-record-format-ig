# PGHD AlcholConsumption Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD AlcholConsumption Profile 
...
* Derived from this Profile: [PGHD AlcholUse Profile](StructureDefinition-pghd-alchol-use.md)
* Refer to this Profile: [PGHD Workout Profile](StructureDefinition-pghd-workout.md)
* Examples for this Profile: [Observation/pghd-alchol-consumption-blood-alcohol-content](Observation-pghd-alchol-consumption-blood-alcohol-content.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-alchol-consumption)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-alchol-consumption.csv), [Excel](../StructureDefinition-pghd-alchol-consumption.xlsx), [Schematron](../StructureDefinition-pghd-alchol-consumption.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-alchol-consumption",
  "version" : "1.0.0-ballot2",
  "name" : "PGHDAlcholConsumption",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/phr/ValueSet/observation-alchol-consumption-codes"
        }
      },
      {
