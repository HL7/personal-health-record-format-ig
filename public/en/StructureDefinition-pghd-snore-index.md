# PGHD SnoreIndex Profile - Personal Health Records v1.0.0-ballot2
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-snore-index)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-snore-index.csv), [Excel](../StructureDefinition-pghd-snore-index.xlsx), [Schematron](../StructureDefinition-pghd-snore-index.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-snore-index",
