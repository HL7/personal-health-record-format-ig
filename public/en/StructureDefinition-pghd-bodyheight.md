# PGHD BodyHeight Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD BodyHeight Profile 
...
* Examples for this Profile: [Observation/pghd-bodyheight](Observation-pghd-bodyheight.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-bodyheight)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-bodyheight.csv), [Excel](../StructureDefinition-pghd-bodyheight.xlsx), [Schematron](../StructureDefinition-pghd-bodyheight.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-bodyheight",
