# PGHD Mindfulness Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD Mindfulness Profile 
...
* Examples for this Profile: [Observation/pghd-mindfulness-mindful-session](Observation-pghd-mindfulness-mindful-session.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-mindfulness)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-mindfulness.csv), [Excel](../StructureDefinition-pghd-mindfulness.xlsx), [Schematron](../StructureDefinition-pghd-mindfulness.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-mindfulness",
  "version" : "1.0.0-ballot2",
  "name" : "PGHDMindfulness",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/phr/ValueSet/observation-mindfulness-codes"
        }
      },
      {
