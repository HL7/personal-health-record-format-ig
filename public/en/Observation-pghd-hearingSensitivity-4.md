# pghd-hearingSensitivity-4 - Personal Health Records v1.0.0-ballot2

## Example Observation: pghd-hearingSensitivity-4

Language: en

Profile: [PGHD HearingSensitivity Profile](StructureDefinition-pghd-hearing-sensitivity.md)

**identifier**: `urn:uuid:2a0d59fe-e99f-d216-5865-670442becaa3`/DE430E9B-03F4-4310-ACA1-508787B240CD_4
...
> **component****code**:Frequency**value**: 4000 Hz(Details: UCUM codeHz = 'Hz')

> **component****code**:Left ear sensitivity**value**: 40 dB(Details: UCUM codedB = 'dB')

> **component****code**:Right ear sensitivity**value**: 45 dB(Details: UCUM codedB = 'dB')
