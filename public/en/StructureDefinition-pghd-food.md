# PGHD Food Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD Food Profile 
...
* Examples for this Profile: [Observation/pghd-food](Observation-pghd-food.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-food)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-food.csv), [Excel](../StructureDefinition-pghd-food.xlsx), [Schematron](../StructureDefinition-pghd-food.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-food",
