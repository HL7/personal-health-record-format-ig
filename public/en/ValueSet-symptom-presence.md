# Symptom Presence - Personal Health Records v1.0.0-ballot2
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/ValueSet/symptom-presence",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "http://hl7.org/fhir/uv/phr/CodeSystem/presence-codes"
      }
    ]
  }
}
