# PGHD Vital Signs Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD Vital Signs Profile 
...
* Derived from this Profile: [PGHD Cardiac Function Profile](StructureDefinition-pghd-cardiac-function.md)
* Examples for this Profile: [Observation/pghd-vitalsigns-apple-sleeping-wrist-temperature](Observation-pghd-vitalsigns-apple-sleeping-wrist-temperature.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-vitalsigns)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-vitalsigns.csv), [Excel](../StructureDefinition-pghd-vitalsigns.xlsx), [Schematron](../StructureDefinition-pghd-vitalsigns.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-vitalsigns",
