# PGHD Pregnancy Status Profile - Personal Health Records v1.0.0-ballot2
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-pregnancy-status)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-pregnancy-status.csv), [Excel](../StructureDefinition-pghd-pregnancy-status.xlsx), [Schematron](../StructureDefinition-pghd-pregnancy-status.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-pregnancy-status",
  "version" : "1.0.0-ballot2",
  "name" : "PGHDPregnancyStatus",
