# PGHD Self Care Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD Self Care Profile 
...
* Examples for this Profile: [Observation/pghd-selfcare-handwashingEvent](Observation-pghd-selfcare-handwashingEvent.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-selfcare)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-selfcare.csv), [Excel](../StructureDefinition-pghd-selfcare.xlsx), [Schematron](../StructureDefinition-pghd-selfcare.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-selfcare",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/phr/ValueSet/observation-selfcare-codes"
        }
      },
      {
