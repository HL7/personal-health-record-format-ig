# Snore Event Item Codes - Personal Health Records v1.0.0-ballot2

## CodeSystem: Snore Event Item Codes 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/CodeSystem/snore-event-item-codes",
