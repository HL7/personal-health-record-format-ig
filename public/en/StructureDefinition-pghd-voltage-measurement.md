# PGHD VoltageMeasurement Profile - Personal Health Records v1.0.0-ballot2
...
* Examples for this Profile: [Observation/pghd-voltage-measurement](Observation-pghd-voltage-measurement.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-voltage-measurement)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-voltage-measurement.csv), [Excel](../StructureDefinition-pghd-voltage-measurement.xlsx), [Schematron](../StructureDefinition-pghd-voltage-measurement.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-voltage-measurement",
  "version" : "1.0.0-ballot2",
  "name" : "PGHDVoltageMeasurement",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/phr/ValueSet/observation-ecg-lead-codes"
        }
      },
      {
        ...
        "min" : 1,
        "fixedUri" : "http://hl7.org/fhir/uv/phr/CodeSystem/ecg-lead-codes",
        "mustSupport" : true
      },
      {
