# PGHD Audiogram Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD Audiogram Profile 
...
* Examples for this Profile: [Observation/pghd-audiogram](Observation-pghd-audiogram.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-audiogram)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-audiogram.csv), [Excel](../StructureDefinition-pghd-audiogram.xlsx), [Schematron](../StructureDefinition-pghd-audiogram.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-audiogram",
