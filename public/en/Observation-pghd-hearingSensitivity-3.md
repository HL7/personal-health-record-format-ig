# pghd-hearingSensitivity-3 - Personal Health Records v1.0.0-ballot2

## Example Observation: pghd-hearingSensitivity-3
...
> **component****code**:Frequency**value**: 2000 Hz(Details: UCUM codeHz = 'Hz')

> **component****code**:Left ear sensitivity**value**: 70 dB(Details: UCUM codedB = 'dB')

> **component****code**:Right ear sensitivity**value**: 75 dB(Details: UCUM codedB = 'dB')
