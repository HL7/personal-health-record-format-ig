...
| Radiology | [AcquisitionModality](https://dicom.nema.org/medical/dicom/current/output/chtml/part16/sect_CID_29.html)[Laterality](https://www.hl7.org/fhir/valueset-bodysite-laterality.html)[SNOMED CT Body Structures](https://www.hl7.org/fhir/valueset-body-site.html) | DICOM, JPG, PNG | ~1GB | Per Study | Surgical PlanningAutosegmentationLesion DetectionRadiation Therapy Planning |
