# PGHD Diving Profile - Personal Health Records v1.0.0-ballot2
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-diving)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-diving.csv), [Excel](../StructureDefinition-pghd-diving.xlsx), [Schematron](../StructureDefinition-pghd-diving.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-diving",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/phr/ValueSet/observation-diving-codes"
        }
      },
      {
