# PGHD BodyWeight Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD BodyWeight Profile 
...
* Examples for this Profile: [Observation/pghd-bodyweight](Observation-pghd-bodyweight.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-bodyweight)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-bodyweight.csv), [Excel](../StructureDefinition-pghd-bodyweight.xlsx), [Schematron](../StructureDefinition-pghd-bodyweight.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-bodyweight",
