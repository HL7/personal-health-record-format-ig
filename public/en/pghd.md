# Patient Generated Health Data (PGHD) - Personal Health Records v1.0.0-ballot2
...
![](pghd/relationship-bw-standards-from-data-perspective.png)
...
![](pghd/data-type-healthkit.png)

![](pghd/data-type-health-connect.png)
...
![](pghd/data-structure-of-healthkit.png)

 ![](pghd/data-structure-of-health-connect.png)

 ![](pghd/data-structure-of-open-mhealth.png)

 ![](pghd/data-structre-of-kanta-phr.png)

![](pghd/common-data-structure-in-phr-standards.png)

 ![](pghd/basics-of-mapping-common-phr-data-structure-to-fhir.png)
