# PGHD Test Result Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD Test Result Profile 
...
* Examples for this Profile: [Observation/pghd-testresult-forced-vital-capacity](Observation-pghd-testresult-forced-vital-capacity.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-testresult)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-testresult.csv), [Excel](../StructureDefinition-pghd-testresult.xlsx), [Schematron](../StructureDefinition-pghd-testresult.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-testresult",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/phr/ValueSet/observation-lab-results-codes"
        }
      },
      {
