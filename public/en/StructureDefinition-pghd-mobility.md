# PGHD Mobility Profile - Personal Health Records v1.0.0-ballot2

## Resource Profile: PGHD Mobility Profile 
...
* Examples for this Profile: [Observation/pghd-mobility-stair-descent-speed](Observation-pghd-mobility-stair-descent-speed.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.uv.phr|current/StructureDefinition/pghd-mobility)
...
Other representations of profile: [CSV](../StructureDefinition-pghd-mobility.csv), [Excel](../StructureDefinition-pghd-mobility.xlsx), [Schematron](../StructureDefinition-pghd-mobility.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-mobility",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "http://hl7.org/fhir/uv/phr/ValueSet/observation-mobility-codes"
        }
      },
      {
