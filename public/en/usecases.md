# Use Cases - Personal Health Records v1.0.0-ballot2

## Use Cases

This guide is particularly interested in the problem of collecting and aggregating medical records from multiple healthcare systems and devices into a coherent whole. In the healthcare industry, these types of compiled records are known as `longitudinal` records. The following use cases illustrate the situations in which a Personal Health Record becomes valuable, along with narrative scenarios describing how a PHR supports each one.

### Longitudinal Health Records

Assembly of records over a long time span; generally multiple decades (20 years or more), and possibly from different healthcare systems with different practices or standards of care.
...
Clinical studies that follow up on patient results after 20 or more years. Very important for pediatric studies.
...
Many patients have more than one home location, and may spend time in different parts of the country on a seasonal basis. This leads to medical records that are fragmented.
...
Symptoms of an illness can evolve as the condition improves or worsens, impacted by such things as climate or diet or circumstances of life.
...
An example of an ongoing longitudinal study that has captured national and worldwide attention, as we continued to determine the long-term effects of COVID-19.
...
Not all medical conditions are reported to all healthcare providers. Conversely, specialists will report results for one area of medicine, which needs to be incorporated and reconciled with the patient's master record.
...
Digital records of an individual's daily activities collected continuously from wearable devices, smartphones, and smart home sensors, including step counts, sleep duration and quality, heart rate, and other biometric measurements that can be used for predictive and preemptive medicine by establishing baseline health patterns and detecting early warning signs of deterioration.

Priya has worn a smartwatch and used a sleep-tracking ring for the past six years, with step counts, heart rate, heart rate variability, and sleep stages flowing continuously into her PHR through device integration APIs. Her smart scale and home blood pressure cuff contribute weekly measurements, building a multi-year baseline of her normal physiological patterns. When the PHR's analytics detect a sustained elevation in her resting heart rate and a decline in her sleep quality over several weeks, it flags the anomaly for her review. At her next appointment, her physician examines the trend data alongside new lab work and identifies an emerging thyroid condition months earlier than symptoms alone would have prompted a visit, allowing treatment to begin before significant deterioration.

### Healthy Living

Proactive wellness management focused on disease prevention rather than treatment, where individuals without acute conditions use their PHR to optimize lifestyle factors such as nutrition tracking, physical activity goals, sleep hygiene, stress management, and preventive screening schedules to extend healthy life expectancy.

Marcus, 42 and in good health, uses his PHR as the hub for his preventive care strategy. His nutrition tracking app, gym workout logs, and meditation app all synchronize with his PHR, alongside annual physical results and routine lab panels imported from his primary care provider via FHIR APIs. The PHR tracks his preventive screening schedule, reminding him when he is due for a cholesterol panel, dental cleaning, or, as he approaches 45, his first colorectal cancer screening. Because his family history of cardiovascular disease is recorded in the PHR, it surfaces guideline-based recommendations for earlier and more frequent lipid monitoring. At his annual checkup, his physician reviews a year of lifestyle data alongside lab trends, and together they set evidence-based goals for the year ahead.

### Differential Diagnoses

Case presentation for rare diseases can require differential diagnosis, as clinicians generate hypotheses and tests for one condition after another to explain a set of symptoms.
...
Massage, Acupuncture, etc. - Patients may wish to track alternative modalities of healthcare that are not recognized or tracked by a healthcare provider or network.
...
Patients may wish to utilize consumer medical devices for tracking their own health.
...
Custody and care of foster children, especially when it crosses state lines, can be complicated; requiring detailed record keeping to align both medical and court proceedings.
...
Patients that have immigrated will necessarily have fragmented records that exist in multiple locations or countries.
...
Patients that have been forced to relocate, due to fires, floods, and similar events, will likely have medical records in multiple clinics or hospitals.
