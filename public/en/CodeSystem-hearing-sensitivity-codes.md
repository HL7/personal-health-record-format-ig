# Hearing Sensitivity Codes - Personal Health Records v1.0.0-ballot2

## CodeSystem: Hearing Sensitivity Codes 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/uv/phr/CodeSystem/hearing-sensitivity-codes",
