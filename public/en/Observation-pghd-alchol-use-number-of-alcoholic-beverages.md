# pghd-alchol-use-numberOfAlcoholicBeverages - Personal Health Records v1.0.0-ballot2

## Example Observation: pghd-alchol-use-numberOfAlcoholicBeverages
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "http://hl7.org/fhir/uv/phr/StructureDefinition/pghd-alchol-use"
    ]
  },
  "language" : "en",
  "contained" : [
